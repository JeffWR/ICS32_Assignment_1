...
TEST_FILES = [
    ...
    (pathlib.Path('notebook.json'), {'username': 'mark', 'password': 'securepassword', 'bio': 'I am mark',
                                     '_diaries': [{'entry': 'My first diary entry', 'timestamp': str(time.time())},
                                                  {'entry': 'My second diary entry', 'timestamp': str(time.time())}]}),
]
