...
def Create_Notebook(Command_Line) -> Tuple[Optional[Path], Optional[Notebook]]:
    """
    ...
    if quote_char not in ['"',"'"] or '-n' not in shlex.split(Command_Line):
        print("ERROR")
        return None, None
...
def Delete_Notebook(Command_Line) -> None:
    """
...
def Load_Notebook(Command_Line) -> Tuple[Optional[Path], Optional[Notebook]]:
    """
    ...
    try:
        ...
        if notebook.username and username == notebook.username and password == notebook.password:
...
def Edite_Notebook(Command_Line,Notebookpass,Notebook) -> None:
    """
    flag
    """
    line = shlex.split(Command_Line)
    ...
    try:
        ...
        print("ERROR")
def Print_Notebook(Command_Line,Notebook) -> None:
    """
    flag
    """
    line = shlex.split(Command_Line)
